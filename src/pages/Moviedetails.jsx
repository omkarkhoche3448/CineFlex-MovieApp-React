...
import { asyncloadmovie, removeMovie } from "../services/movieAction";
...
function Moviedetails() {
    document.title = "MoviFlex | Movie Details";
            ...
            <div className='w-full relative mx-auto flex flex-col mt-32'>
                <div
                    className="w-full h-[33vh] lg:h-screen bg-gradient-to-t from-black to-black/500
                         p-4 text-center text-xl font-bold absolute bottom-[50%]  "
                ></div>

                <div className="w-[80%] mx-auto flex flex-col lg:flex-row justify-center mt-36 space-y-10 lg:space-y-0 lg:space-x-44">
                    <img
                        className="shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] h-[50vh] lg:h-[50vh] object-cover rounded-md static z-20"
                    ...
                    <div className="w-full lg:w-[40%] text-white z-10">
                        ...
                        <div className="w-[80%] flex flex-wrap gap-y-5 mt-12 ">
                            {info.watchproviders && info.watchproviders.flatrate && (
                                <div className="flex gap-x-10 -mt-8 items-center text-white">
                ...
                <div className="w-full h-[33vh] lg:h-[50vh] absolute bottom-0 left-0 right-0"

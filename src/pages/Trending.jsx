...
const Trending = () => {
  ...
  return loading ? (
    ...
    <div className="w-full mx-auto px-4 overflow-x-hidden">
      <div className="max-w-full mx-auto flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-5 mt-32 items-center">
        <div className="flex flex-col flex-wrap gap-4 justify-center lg:flex-row space-y-4  lg:space-y-0 lg:space-x-5 w-full items-center">
          <DropDown
            title="Trending"
            options={[
              { id: "all", name: "All" },
          ...
          <button
            className="bg-red-400 flex items-center justify-center text-white rounded px-4 py-2 mt-4 lg:mt-0"
            onClick={handleReset}
          >
